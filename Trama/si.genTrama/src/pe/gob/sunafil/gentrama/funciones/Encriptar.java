...
public class Encriptar {
     ...
     */
     public static String Encriptar(String pLogin, String pClave) {
         System.out.println("entra al desencriptar");
     ...
     */
      public static String Desencriptar(String pLogin, String pCripto) {
        ...
        depurador.debug("Desencriptamos por primera vez");
        ...
        depurador.debug("Igualamos las dos cadenas");        
        ...
        depurador.debug("Obtenemos número mágico");
        li_Magia = Integer.parseInt(ls_Cripto.substring(ls_Cripto.length()- 5, ls_Cripto.length()-2));        

        
        depurador.debug("Desencriptamos por segunda vez");
     ...
     */
     public static int total_segundos(){             
             Date now = new Date();   
             /*depurador.info("horas => "+now.getHours());            
             depurador.info("minuts => "+now.getMinutes());            
             depurador.info("segundos => "+now.getSeconds());            */
             int cant = (Integer.parseInt(""+now.getHours()*3600)) + (Integer.parseInt(""+now.getMinutes()*60))+ Integer.parseInt(""+now.getSeconds()); 
             //depurador.info("Cantidad => "+cant); 
