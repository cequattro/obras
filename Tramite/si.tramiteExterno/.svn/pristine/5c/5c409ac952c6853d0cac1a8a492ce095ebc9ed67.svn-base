...
public class RegistrarDespatch {
	 ...
	 {
		 return registrarDAO.getTipoDocTramiteCongresal();
	 }
	 ...
	 {
		 return registrarDAO.getProcedimientoAll(nNumint);
	 }
	 ...
	 {
		 return registrarDAO.getAsociacionPorInspeccion(parametros, dependenciasSIIT);
	 }
	 ...
	 {
		 return registrarDAO.getRequisitosPorTupaAll(tupa);
	 }
