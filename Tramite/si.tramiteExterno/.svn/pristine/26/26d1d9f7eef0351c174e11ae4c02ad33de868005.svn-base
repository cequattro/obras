...
import pe.gob.sunafil.tramiteext.bean.Periodo;
import pe.gob.sunafil.tramiteext.bean.Permisos;
import pe.gob.sunafil.tramiteext.bean.Usuario;
import pe.gob.sunafil.tramiteext.facade.LoginFacade;
...
import pe.gob.sunafil.tramiteext.mybatis.interfase.INTLogin;
...
public class LoginBean implements Serializable{
	...
	public String Login(){		
		...
		try {
            ...
            enh.setN_nivel("2");
            enh.setV_codpad("350");
            enh.setV_desmen("Nuevo");
            enh.setV_url("#{registrarBean.nuevoRegistro}");//doMantCedulas.do?method=inicio
