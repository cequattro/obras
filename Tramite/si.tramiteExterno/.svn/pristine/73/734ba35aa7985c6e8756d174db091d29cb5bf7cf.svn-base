...
public class CargaAppBean implements Serializable {
	...
	public void CargaApp(){
		 ...
		 //depurador.info("-- Load App --");
	        ...
	        try{
	            sistema = Funciones.ObtieneProperty("pe.gob.sunafil.tramiteext.util.properties.mtpe_app","mtpe.framework.sistema");
	            tamano = Funciones.ObtieneProperty("pe.gob.sunafil.tramiteext.util.properties.mtpe_app","mtpe.framework.pagina.tamano");
	            menu = Funciones.ObtieneProperty("pe.gob.sunafil.tramiteext.util.properties.mtpe_app","mtpe.framework.menu");
	            seguridad = Funciones.ObtieneProperty("pe.gob.sunafil.tramiteext.util.properties.mtpe_app","mtpe.framework.seguridad");        
