...
public class Persona  {
	...
	public String toString() {
		return "Persona [vCodtdocide=" + vCodtdocide + ", vNumdoc=" + vNumdoc + ", vApepater=" + vApepater
				+ ", vApemater=" + vApemater + ", vNombres=" + vNombres + ", dFecnac=" + dFecnac + ", cCodsexo="
				+ cCodsexo + ", cEstcivil=" + cEstcivil + ", dFecfac=" + dFecfac + ", dFecact=" + dFecact
				+ ", vCodpais=" + vCodpais + ", cEstact=" + cEstact + ", dFecreg=" + dFecreg + ", dFecmod=" + dFecmod
				+ ", dFecanul=" + dFecanul + ", vCodnacion=" + vCodnacion + ", vTelfper1=" + vTelfper1 + ", vTelfper2="
				+ vTelfper2 + ", vEmail=" + vEmail + ", vCodsisreg=" + vCodsisreg + ", vFlgplan=" + vFlgplan
				+ ", vHostreg=" + vHostreg + ", vHostmod=" + vHostmod + ", vNomusureg=" + vNomusureg + ", vNomusumod="
				+ vNomusumod + ", vCodpaisnac=" + vCodpaisnac + ", vCoddepnac=" + vCoddepnac + ", vCodpronac="
				+ vCodpronac + ", vCoddisnac=" + vCoddisnac + ", vCodsismod=" + vCodsismod + ", vFlatradis="
				+ vFlatradis + ", vFlgtiploc=" + vFlgtiploc + ", vFlgtipcom=" + vFlgtipcom + ", vFlgtipdes="
				+ vFlgtipdes + ", vFlgtipcon=" + vFlgtipcon + ", vFlgtipsit=" + vFlgtipsit + ", vFlgme=" + vFlgme
				+ ", vFlgna=" + vFlgna + ", vFlgam=" + vFlgam + ", vCodnivedu=" + vCodnivedu + ", vFlgreniec="
				+ vFlgreniec + ", v_coderror=" + v_coderror + "]";
	}
