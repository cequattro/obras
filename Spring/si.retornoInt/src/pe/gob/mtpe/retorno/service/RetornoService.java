...
public interface RetornoService {
	...
	/**
	 * Metodo que obtiene la lista los retornantes
	 * @param paramAdmRetorno objeto de la clase {@link pe.gob.mtpe.retorno.bean.ParamAdmRetorno ParamAdmRetorno} usa como parametros de consulta la llave vCodtdocide, vNumdoc 
	 * @throws Exception Exception excepcion general
	 */
