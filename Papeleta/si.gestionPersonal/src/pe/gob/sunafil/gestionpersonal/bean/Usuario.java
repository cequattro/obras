...
public class Usuario implements Serializable {
    ...
    /**
     * (String)Atributo que almacena la contraseña del usuario del formulario.
     */
	 ...
	 * @return the n_numint
	 */
	public String getN_numint() {
		return n_numint;
	}
	/**
	 * @param n_numint the n_numint to set
	 */
	public void setN_numint(String n_numint) {
		this.n_numint = n_numint;
	}
    ...
    public String toString() {
        String cadena = null;
        cadena = "\n";
        cadena += " \tINFO - UsuarioBean : (String)v_usuario => "+v_usuario+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_contrasena => "+v_contrasena+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_codsis => "+v_codsis+"\n";    
        cadena += " \tINFO - UsuarioBean : (String)v_codusu => "+v_codusu+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_passusu => "+v_passusu+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_flgact => "+v_flgact+"\n";
        cadena += " \tINFO - UsuarioBean : (String)n_admin => "+n_admin+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_codpersonal => "+v_codpersonal+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_desapepat => "+v_desapepat+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_desapemat => "+v_desapemat+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_desnombres => "+v_desnombres+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_codcargo => "+v_codcargo+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_nomcargo => "+v_nomcargo+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_descargo => "+v_descargo+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_codescala => "+v_codescala+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_abrvescala => "+v_abrvescala+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_nomescala => "+v_nomescala+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_desescala => "+v_desescala+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_codtipo => "+v_codtipo+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_destipo => "+v_destipo+"\n";
        cadena += " \tINFO - UsuarioBean : (String)n_numdep => "+n_numdep+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_coddep => "+v_coddep+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_desdep => "+v_desdep+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_desdepabr => "+v_desdepabr+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_codzon => "+v_codzon+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_nomzon => "+v_nomzon+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_codreg => "+v_codreg+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_nomreg => "+v_nomreg+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_codep => "+v_codep+"\n";
        cadena += " \tINFO - UsuarioBean : (String)v_hostreg => "+v_hostreg+"\n";
        cadena += " \tINFO - UsuarioBean : (String)n_numint => "+n_numint+"\n";
        return cadena;
    }
