package pe.gob.sunafil.gestionpersonal.reniecws;
...
import pe.gob.sunafil.gestionpersonal.managedBeans.LoginBean;
import pe.gob.sunafil.gestionpersonal.mybatis.despachadores.PersonaReniecDespatch;
import pe.gob.sunafil.gestionpersonal.mybatis.despachadores.WebServiceDespatch;
		...
		try {
			...
			if (persona.getV_codtdocide().equals("03")) {
				...
				if("ENR".equals(verificacion) || "NE".equals(verificacion))
				{
					...
					logger.info("PERSONA ACTUALIZADA ES "+persona.getV_numdoc());
