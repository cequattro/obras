...
public class RhtbcTurnodiaExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andCorrelativoActual(Short nCodturno) {
        	  StringBuffer sb = new StringBuffer("N_CODTURNODIA in (select max(N_CODTURNODIA) from RRHHSYS.RHTBC_TURNODIA where N_CODTURNO="+nCodturno+")");    	  
