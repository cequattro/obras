package pe.gob.sunafil.denunciavirtual.funciones;
...
public class Funciones {
     ...
     */
     ...
     /**
      * Obtiene un dato del archivo Property: pe.gob.sunafil.denunciavirtual.util.properties.sunafil_app
      * @param dato Dato dentor del archivo Property.
      * @return (String)
      */
      public static String ObtProp_App(String dato) {
         String variable = "";
         try {
             ResourceBundle bundle = ResourceBundle.getBundle("pe.gob.sunafil.denunciavirtual.util.properties.sunafil_app");
             variable = bundle.getString(dato);
         } catch (Exception e) {
             depurador.info("ERROR : Funciones : ObtenerDatosProperties => : "+e);
         }
      ...
      /**
       * Obtiene un dato del archivo Property: pe.gob.sunafil.denunciavirtual.util.properties.mtpe_resources
       * @param dato Dato dentor del archivo Property.
       * @return (String)
       */
       public static String ObtProp_Resources(String dato) {
          String variable = "";
          try {
              ResourceBundle bundle = ResourceBundle.getBundle("pe.gob.sunafil.denunciavirtual.util.properties.sunafil_resources");
              variable = bundle.getString(dato);
          } catch (Exception e) {
              depurador.info("ERROR : Funciones : ObtenerDatosProperties => : "+e);
          }
