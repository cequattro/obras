...
public class IMPCombos implements INTCombos,Serializable {
	...
	public List<Combo> listaComboXTipo(String tipo) throws Exception {
		...
		try {
			...
			}else if("DepartamentoEmp".equalsIgnoreCase(tipo)){
				lista=session.selectList("Combos.departamentosEmp");	
	...
	/**
	 * Lista todas las provincias de un departamento seleccionado.
	 */
	...
	/**
	 * Lista las provincias del departamento de competencia de SUNAFIL Seleccionado
	 * @param coddep
	 * @return
	 * @throws Exception
	 */
	public List<Combo> listaProvinciasxDepEmp(String coddep) throws Exception {
		...
		try {
			Map param = new HashMap<String, String>();
			param.put("coddep", coddep);
			lista=session.selectList("Combos.provinciasxDepEmp",param);
	...
	public List<Combo> listaDistritosxProEmp(String coddep,String codpro) throws Exception {
		...
		try {
			...
			param.put("coddep", coddep);
			param.put("codpro", codpro);
			lista=session.selectList("Combos.distritosxProEmp",param);
