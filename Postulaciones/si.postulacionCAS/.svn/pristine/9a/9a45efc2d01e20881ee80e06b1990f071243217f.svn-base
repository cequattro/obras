...
import pe.gob.sunafil.postulacioncas.mybatis.despachadores.PersonaReniecDespatch;
import pe.gob.sunafil.postulacioncas.mybatis.despachadores.WebServiceDespatch;
...
public class ReniecWebService {
	...
	public ReniecBean obtenerPersonaSWReniec(Persona persona,String sistema){
		...
		try {
			...
			if (persona.getV_codtdocide().equals("03")) {
				...
				if("ENR".equals(verificacion) || "NE".equals(verificacion)){//ENR:EXISTE Y NO ES DE RENIEC, NE: NO EXISTE
					...
					if("0000".equals(resultPersona.getV_coderror())){
						...
						System.out.println("Departamento Codigo: ["+resultPersona.getV_coddepnac()+"] - Descripcion: ["+resultPersona.getV_desdepnac()+"]");
						System.out.println("Provincia Codigo: ["+resultPersona.getV_codprovnac()+"] - Descripcion: ["+resultPersona.getV_desprovnac()+"]");
						System.out.println("Distrito Codigo: ["+resultPersona.getV_coddisnac()+"] - Descripcion: ["+resultPersona.getV_desdisnac()+"]");
						System.out.println("Estado Civil: "+resultPersona.getV_estciv());
						...
						if(validaEnvioCorreo==true){
							...
							direcciones[1]="amatienzo@sunafil.gob.pe";//matiew
							direcciones[2]="rgarrido@sunafil.gob.pe";//Richard
							direcciones[3]="wcastro@sunafil.gob.pe";//willy
							direcciones[4]="sistemas.sunafil@gmail.com";
							String mensaje="";								
							String asunto="Error Web Service de RENIEC EN EL SISTEMA DE POSTULACION CAS ("+resultPersona.getV_coderror()+")";
			...
			direcciones[3]="wcastro@sunafil.gob.pe";//wcastro
			direcciones[4]="sistemas.sunafil@gmail.com";
			String mensaje="";								
			String asunto="Servicio RENIEC CAIDO(AXISFAULT) - Web Service de RENIEC en EL SISTEMA DE POSTULACION CAS";
			...
			if(paso.equals("1")){//SI SE QUEDO EN PASO 1 QUIERE DECIR QUE EL WS ARROJÓ EL ERROR.
				...
				direcciones[4]="sistemas.sunafil@gmail.com";
				String mensaje="";								
				String asunto="Error GRAVE Web Service de RENIEC en EL SISTEMA DE POSTULACION CAS";
				mensaje="DNI consultado =<b>'"+persona.getV_numdoc()+"'</b> <br/><br/><b>:::EXCEPTION (e):</b> "
						 + "<br/><br/> <b>:::e.printStackTrace()=></b><br/><br/> "
						 + EnviarMail.getStackTraceToHTML(e);
				if(direcciones.length>0 && direcciones!=null){
