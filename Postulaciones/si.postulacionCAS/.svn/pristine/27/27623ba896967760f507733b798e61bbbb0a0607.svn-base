...
import pe.gob.sunafil.postulacioncas.mybatis.despachadores.ConsultaSIITDespatch;
import pe.gob.sunafil.postulacioncas.mybatis.despachadores.IntendenciasDespatch;
...
public class ConsultaSIITBean  implements Serializable {
	...
	/**
	 * Metodo que nos lleva a la pagina de consulta de RMP
	 * @return vista
	 */
	public String toConsultaSIIT(){
		logger.info("Ingresando a la Consulta");
		//LIMPIAMOS LA PAGINA:
		inicializar();
		return "pretty:consulta";
	}
