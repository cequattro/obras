		 ...
		 logger.info("-- Load App --");
	        ...
	        try{
	        	...
	        	if(haysesion){
		            ...
		            tamano = Funciones.ObtieneProperty("pe.gob.sunafil.postulacioncas.util.properties.sunafil_app","sunafil.framework.pagina.tamano");
		            seguridad = Funciones.ObtieneProperty("pe.gob.sunafil.postulacioncas.util.properties.sunafil_app","sunafil.framework.seguridad");        
